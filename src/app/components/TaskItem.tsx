...
import { Clock, Users, Calendar, Building2, User, AlertCircle, Trash2, Edit, Save, X } from 'lucide-react';
...
export function TaskItem({
  ...
  return (
    <div
      className={`px-6 py-4 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors ${
        task.overdue ? 'bg-red-50 dark:bg-red-900/30' : ''
      }`}
    >
