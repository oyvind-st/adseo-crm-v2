  ...
  const tickets = [
    {
      ...
      contactEmail: 'maria@nordictech.no',
      category: 'Rapport og tall',
      priority: 'medium',
      status: 'Open',
      assignee: 'Ola Nordmann',
      opened: '1 dag siden',
      openedDate: '26. april 2026 kl. 14:30',
      ...
      conversation: [
        {
          ...
          message: 'Hei,\n\nJeg ser at trafikktallene i månedsrapporten deres ikke stemmer overens med det jeg ser i Google Analytics. Kan dere forklare forskjellen?\n\nMvh\nMaria',
        ...
        },
        {
          ...
          from: 'Ola Nordmann',
          email: 'ola@adseo.no',
          message: 'Hei Maria,\n\nTakk for henvendelsen! Forskjellen kommer av at vi rapporterer på organisk trafikk (Google Analytics) mens totaltallet inkluderer også betalt trafikk fra Google Ads.\n\nJeg kan sende deg en detaljert rapport som viser fordelingen hvis det er nyttig?\n\nMvh\nOla',
          timestamp: '23 timer siden',
          type: 'agent'
        },
        {
          id: '3',
          from: 'Maria Hansen',
          email: 'maria@nordictech.no',
          message: 'Takk for rask respons! Det forklarer forskjellen. Ja, jeg vil gjerne ha en detaljert rapport som viser fordelingen mellom organisk og betalt trafikk.',
          timestamp: '20 timer siden',
          type: 'customer'
        },
        {
          id: '4',
          from: 'Ola Nordmann',
          email: 'ola@adseo.no',
          message: 'Perfekt! Jeg setter i gang med rapporten med en gang og sender den til deg i løpet av dagen.',
          timestamp: '19 timer siden',
          type: 'agent'
        },
        {
          id: '5',
          from: 'Ola Nordmann',
          email: 'ola@adseo.no',
          message: 'Hei igjen Maria,\n\nHer er den detaljerte rapporten som viser fordelingen:\n\n- Organisk trafikk: 15 234 besøk\n- Betalt trafikk (Google Ads): 8 456 besøk\n- Total: 23 690 besøk\n\nSe vedlagt PDF for fullstendig analyse.\n\nMvh\nOla',
          timestamp: '12 timer siden',
          type: 'agent'
        },
        {
          id: '6',
          from: 'Maria Hansen',
          email: 'maria@nordictech.no',
          message: 'Supert, dette var akkurat det jeg trengte! Nå ser jeg sammenhengen. Takk for hjelpen!',
    ...
    },
    {
      ...
      customerId: '3',
      contact: 'Per Olsen',
      contactEmail: 'per@retail.no',
      category: 'Kampanjeendring',
      priority: 'high',
      status: 'In progress',
      assignee: 'Kari Jensen',
      opened: '30 minutter siden',
      openedDate: '27. april 2026 kl. 16:30',
      ...
      conversation: [
        {
          ...
          from: 'Per Olsen',
          email: 'per@retail.no',
          message: 'Hei,\n\nVi har sett gode resultater på Shopping-kampanjene og ønsker å flytte 50% av budsjettet fra Search-kampanjene over til Shopping.\n\nKan dere gjøre dette denne uken?\n\nMvh\nPer',
          timestamp: '30 minutter siden',
          type: 'customer'
        }
      ]
    },
    {
      ...
      customerId: '6',
      contact: 'Nina Hansen',
      contactEmail: 'nina@ecommercepro.no',
      category: 'Teknisk feil',
      priority: 'high',
      status: 'Open',
      assignee: 'Ola Nordmann',
      opened: '4 timer siden',
      openedDate: '27. april 2026 kl. 13:00',
      ...
      conversation: [
        {
          ...
          message: 'Hei,\n\nVi ser at conversions ikke registreres i GA4. Siste conversion var for 3 dager siden, men vi vet at vi har hatt salg i mellomtiden.\n\nMvh\nNina',
        ...
        },
        {
          ...
          from: 'Ola Nordmann',
          email: 'ola@adseo.no',
          message: 'Hei Nina,\n\nJeg sjekker dette med en gang. Kan du bekrefte om dere har gjort noen endringer på nettsiden de siste dagene?\n\nMvh\nOla',
