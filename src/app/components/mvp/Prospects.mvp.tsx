...
function mapEnhet(e: any): Company {
  return {
    ...
    kommunenummer: e.forretningsadresse?.kommunenummer || e.postadresse?.kommunenummer,
  ...
  return (
    ...
    >
      ...
      <td className="px-3 py-3">
        ...
        <div className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{company.orgnr}</div>
      </td>
